            ...
            <form action={{route('item.store')}} method="POST">
                ...
                <div class="grid gap-4 mb-6">
                    ...
                    <div class="mb-2">
                        ...
                        <input type="text" id="price" name="price" class="bg-gray-50 border-gray-300 text-gray-900 text-sm rounded-lg w-full">
                    </div>
                    <div class="mb-2">
                        <label for="stock" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                            Stock
                        </label>
                        <input type="text" id="stock" name="stock" class="bg-gray-50 border-gray-300 text-gray-900 text-sm rounded-lg w-full">
                    </div>
                    <div class="mb-2">
                        <label for="description" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                            Description
                        </label>
                        <textarea type="text" id="description" rows="3" name="description" class="bg-gray-50 border-gray-300 text-gray-900 text-sm rounded-lg w-full"></textarea>
                    </div>
