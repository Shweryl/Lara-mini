...
<body>
    <div class="container mx-auto mt-10">
        <div class="w-full max-w-md mx-auto bg-white shadow-lg rounded-lg p-8">
            <form action={{route('booklist.store')}} method="POST">
                @csrf
                <div class="grid gap-4 mb-6">
                    ...
                    <div class="mb-2">
                        ...
                        <input type="text" id="author" name="author" class="bg-gray-50 border-gray-300 text-gray-900 text-sm rounded-lg w-full">
                    </div>
                    <div class="mb-2">
                        <label for="genres" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                            Genres
                        </label>
                        <input type="text" id="genres" name="genres" class="bg-gray-50 border-gray-300 text-gray-900 text-sm rounded-lg w-full">
                    </div>
                    <div class="mb-2">
                        <label for="published_at" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                            Published_at
                        </label>
                        <input type="text" id="published-at" name="published_at" class="bg-gray-50 border-gray-300 text-gray-900 text-sm rounded-lg w-full">
                    </div>
