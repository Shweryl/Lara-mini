            ...
            <form action={{route('employer.store')}} method="POST">
                ...
                <div class="grid gap-4 mb-6">
                    ...
                    <div class="mb-2">
                        ...
                        <input type="text" id="age" name="age" class="bg-gray-50 border-gray-300 text-gray-900 text-sm rounded-lg w-full">
                    </div>
                    <div class="mb-2">
                        <label for="gender" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                            Gender
                        </label>
                        <input type="text" id="gender" name="gender" class="bg-gray-50 border-gray-300 text-gray-900 text-sm rounded-lg w-full">
                    </div>
                    <div class="mb-2">
                        <label for="position" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                            Position
                        </label>
                        <input type="text" id="position" name="position" class="bg-gray-50 border-gray-300 text-gray-900 text-sm rounded-lg w-full">
                    </div>
                    <div class="mb-2">
                        <label for="year_of_experience" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                            Year_of_experience
                        </label>
                        <input type="text" id="year_of_experience" name="year_of_experience" class="bg-gray-50 border-gray-300 text-gray-900 text-sm rounded-lg w-full">
                    </div>
